    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2.5 shrink-0">
          <img
            src={getImagePath("/images/logo-bellamix-preto.png")}
            alt="Bella Mix Brasil"
            className="h-9 w-9 rounded-full object-cover"
          />
          <div className="leading-none">
            <div className="font-black text-sm tracking-wide" style={{ color: "#E09400" }}>BELLA MIX</div>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-500">
          ...
          <Link href="/produto/kit-7-em-1-bege" className="hover:text-gray-900 transition-colors">Kit 7 em 1</Link>
        </nav>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100">
          <nav className="max-w-6xl mx-auto px-4 py-3 flex flex-col divide-y divide-gray-100">
            ...
            <Link href="/produto/kit-7-em-1-bege" onClick={() => setMenuOpen(false)} className="py-3 text-sm font-medium text-gray-700">Kit 7 em 1</Link>
