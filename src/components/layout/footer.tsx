      ...
      <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
        ...
        <div className="text-center sm:text-left mb-8 pb-6 border-b border-gray-800">
          <Link href="/" className="inline-flex items-center gap-2.5 mb-3">
            <img src={getImagePath("/images/logo-bellamix-preto.png")} alt="Bella Mix Brasil" className="h-10 w-10 rounded-full object-cover" />
            <div className="text-left">
              <div className="font-black text-sm tracking-wide" style={{ color: "#f5b800" }}>BELLA MIX</div>
